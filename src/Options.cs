...
namespace TrailingWhitespace
{
    public class Options : DialogPage
    {
        public Options()
        {
            ...
            OnlyRemoveFromModifiedLines = false;
        }
        ...
        [Category("General")]
        [DisplayName("Only remove from modified lines")]
        [Description("When true, whitespace will only be removed from lines that have been modified since the file was opened.")]
        [DefaultValue(false)]
        public bool OnlyRemoveFromModifiedLines { get; set; }
